...
- (void) loadView {
    ...
    if ([[[UIDevice currentDevice] systemVersion] doubleValue] > 5.0)
    {
        ...
        if ( UIInterfaceOrientationIsLandscape( self.orientation ) ) {
            ...
            [_navBar setBackgroundImage:[UIImage imageNamed:@"header.png"] forBarMetrics:UIBarMetricsDefault];
        } else {
        ...
        //    navItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"cancel.png"] style:UIBarButtonItemStyleDone target:self action:@selector(cancel:)];
